...
import type { Citation } from "../components/chat/MessageBubble";
...
export function ChatPage() {
  ...
  const handleOpenCitations = (citations: Citation[], activeId?: number) => {
    setCitationPanel({ citations, activeId });
  };
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        {citationPanel && (
          <CitationPanel
            ...
            activeCitationId={citationPanel.activeId}
