    ...
    <div className="flex min-h-[80vh] items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="mt-8 space-y-3">
          ...
          <a
            href={`${API_BASE_URL}/api/v1/auth/line`}
            className="flex w-full items-center justify-center gap-3 rounded-lg bg-[#06C755] px-4 py-3 text-sm font-medium text-white shadow-sm transition hover:bg-[#05b34d]"
          >
